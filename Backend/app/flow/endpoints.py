...
def update_flow_node(node_id: str, body: FlowNodeUpdateRequest):
    ...
    if "binding_id" in updates:
        updates["fk_binding_id"] = updates.pop("binding_id")
...
def create_flow(body: FlowCreateRequest):
    ...
    return build_flow_response(repo.create_flow(body.title, body.slug, body.description), repo)
...
@router.get(
    "/flows",
    response_model=list[FlowResponseFull],
    tags=["Flows"],
...
def list_flows():
    ...
    return [build_flow_response(f, repo) for f in flows]
