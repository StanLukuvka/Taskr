...
class FakeApiCaller:
    ...
    def start(self) -> IntegrationResult:
    ...
    def inspect(self, external_ref: str) -> IntegrationResult:
...
class FakeHermesService:
    ...
    def create_task(self, inputs: dict) -> IntegrationResult:
        ...
        * Every other product returns a ``completed`` result.
        ...
        # Fanta requires explicit approval and blocks with a question.
        ...
        # All other products complete immediately.
        return IntegrationResult(
            status="completed",
            external_ref=task_id,
